...
def seed_apps_and_grants(apps, schema_editor):
    ...
    eda_service.frontendUrl = os.getenv("EDA_FRONTEND_URL", "http://localhost:8081")
    eda_service.icon = "📋"
    ...
    config_service.frontendUrl = os.getenv("CONFIGURATION_FRONTEND_URL", "http://localhost:3000")
